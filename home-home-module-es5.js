...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype._toggleSidebar = function () {
        this._opened = !this._opened;
    };
    HomePage.prototype.changeCheck = function (event) {
        this.disabledAgreement = !this.disabledAgreement;
    };
    HomePage.prototype.changeCheckU = function (event) {
    ...
    HomePage.prototype.submit = function () {
        ...
        if (this.Updatedata.vaccine_name == "" || this.Updatedata.hospital == "" || this.Updatedata.vaccine_taken_date == "") {
            ...
            this.api.addRecord(this.Updatedata).subscribe(function (res) {
                if (res) {
                    ...
                    _this.date = "";
                    _this.comments = "";
                    _this.api.getRecords(_this.data).subscribe(function (res) {
                        _this.records = res;
                    });
                }
                else {
    ...
    HomePage.prototype.ngOnInit = function () {
        var _this = this;
        this.api.getName().subscribe(function (res) {
            console.log(res);
            _this.name = res[0][0].toString();
            _this.dob = res[0][1].toString();
        });
        this.api.getRecords(this.data).subscribe(function (res) {
            _this.records = res;
        });
    };
    HomePage.prototype.DeleteRecord = function (record) {
        var _this = this;
        var data = {
            action: "delete",
            email_id: sessionStorage.getItem('email_id'),
        ...
        this.api.delete(data).subscribe(function (res) {
            if (res) {
    ...
    HomePage.prototype.UpdateRecord = function (record) {
        this.update = true;
        this.oldRecord = {
            action: "delete",
            email_id: sessionStorage.getItem('email_id'),
    ...
    HomePage.prototype.Update = function () {
        ...
        this.Updatedata.email_id = sessionStorage.getItem("email_id");
        this.Updatedata.password = sessionStorage.getItem("password");
        this.api.delete(this.oldRecord).subscribe(function (res) {
            console.log(res);
        });
        if (this.Updatedata.vaccine_name == "" || this.Updatedata.hospital == "" || this.Updatedata.vaccine_taken_date == "") {
            alert("Enter all details");
